...
Revision ID: 869e1e580292
Revises: 
Create Date: 2025-08-06 19:03:12.420303
...
def upgrade():
    ...
    with op.batch_alter_table('user', schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column('email_verification_token', sa.String(length=20), nullable=True))
